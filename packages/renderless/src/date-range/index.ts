...
export const getMinVisibleDate = ({ state, t }) => () => {
...
export const getMaxVisibleDate = ({ state, t }) => () => {
...
export const getMinVisibleTime = ({ state, t }) => () => {
...
export const getMaxVisibleTime = ({ state, t }) => () => {
...
export const watchMinDate = ({ state, t, vm }) => (value) => {
...
export const watchMaxDate = ({ state, vm }) => (value) => {
...
export const watchMinTimePickerVisible = ({ nextTick, state, vm }) => (value) => {
  if (value) {
    nextTick(() => {
...
export const watchMaxTimePickerVisible = ({ nextTick, state, vm }) => (value) => {
  if (value) {
    nextTick(() => {
...
export const watchDefault = ({ state }) => (value) => {
...
export const handleDateInput = ({ state, t }) => (value, type) => {
...
export const handleDateChange = ({ state, t }) => (value, type) => {
  const parsedValue = parseDate(value, state.dateFormat, t)
...
export const handleTimeInput = ({ state, t }) => (value, type) => {
...
export const handleTimeChange = ({ state, t, vm }) => (value, type) => {
  const parsedValue = parseDate(value, state.timeFormat, t)
...
export const handleMinTimePick = ({ state }) => (value, visible, first) => {
...
export const handleMaxTimePick = ({ state }) => (value, visible, first) => {
...
export const leftPrevMonth = ({ state }) => () => {
...
export const rightNextMonth = ({ state }) => () => {
  if (!state.unlinkPanels) {
...
export const leftNextMonth = ({ state }) => () => (state.leftDate = nextMonth(state.leftDate))

export const rightPrevYear = ({ state }) => () => (state.rightDate = prevYear(state.rightDate))

export const rightPrevMonth = ({ state }) => () => (state.rightDate = prevMonth(state.rightDate))
